...
class ModelCatalogProduct extends Model {
	...
	public function getProductOptions( $product_id ) {
		...
		$product_option_var_query = $this->db->query( "SELECT * FROM `" . DB_PREFIX . "option_var` WHERE option_var_status = '1'" );
		...
		foreach ( $product_option_query->rows as $product_option ) {
			...
			$variability = 0;
			foreach ( $product_option_var_query->rows as $opt_var ) {
				if ( $opt_var['option_id'] == $product_option['option_id'] ) {
					$variability = 1;
				}
			}
			$product_option_data[] = array(
				...
				'option_variability'   => $variability
			);
