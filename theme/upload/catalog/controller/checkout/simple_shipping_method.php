...
class ControllerCheckoutSimpleShippingMethod extends Controller {
	public function index() {
		...
		$data['show_shipping_comment'] = is_array( $this->config->get( 'theme_gen_checkout_hidden_fields' ) ) && in_array( 'shipping_comment', $this->config->get( 'theme_gen_checkout_hidden_fields' ) );
