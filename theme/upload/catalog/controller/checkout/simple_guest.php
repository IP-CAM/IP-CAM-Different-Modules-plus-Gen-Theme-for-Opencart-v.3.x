...
class ControllerCheckoutSimpleGuest extends Controller {
    public function index() {
        ...
        $data['show_payment_company']   = in_array('payment_company', $this->config->get('theme_gen_checkout_hidden_fields'));
        $data['show_payment_address_2'] = in_array('payment_address_2', $this->config->get('theme_gen_checkout_hidden_fields'));
        $data['show_payment_postcode']  = in_array('payment_postcode', $this->config->get('theme_gen_checkout_hidden_fields'));
        $data['show_payment_country']   = in_array('payment_country', $this->config->get('theme_gen_checkout_hidden_fields'));
        $data['show_payment_email']     = in_array('payment_email', $this->config->get('theme_gen_checkout_hidden_fields'));
