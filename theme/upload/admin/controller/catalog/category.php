...
class ControllerCatalogCategory extends Controller {
    ...
    protected function getForm() {
        ...
        // Admin copy helper
        if ($this->config->get('theme_gen_admin_category_copy_status')) {
            $this->document->addStyle('view/stylesheet/igdev/admin-gen.min.css');
            $data['theme_gen_admin_category_copy_status'] = 1;
        } else {
