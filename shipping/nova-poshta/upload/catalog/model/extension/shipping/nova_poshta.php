      ...
      function getQuote( $address ) {
          ...
          if ( $status ) {
              ...
              $quote_data[ 'nova_poshta' ] = array(
                  ...
                  'cost'         => $this->config->get( 'shipping_nova_poshta_cost' ),
                  'tax_class_id' => $this->config->get( 'shipping_nova_poshta_tax_class_id' ),
                  'text'         => $this->currency->format( $this->tax->calculate( $this->config->get( 'shipping_nova_poshta_cost' ), $this->config->get( 'shipping_nova_poshta_tax_class_id' ), $this->config->get( 'config_tax' ) ), $this->session->data[ 'currency' ] )
              );
